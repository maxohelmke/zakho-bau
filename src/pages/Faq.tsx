...
const faqItems: { q: string; a: string; cat: Category }[] = [
  ...
  },
  {
    ...
    a: "Ja. Sie finden uns an der Hagener Straße 44 in 58285 Gevelsberg. Öffnungszeiten: Montag bis Freitag, 08–17 Uhr. Ein kurzer Anruf vorab ist sinnvoll, damit wir uns Zeit für Sie nehmen können.",
  },
];
...
const Faq = () => {
  ...
  return (
    <div className="min-h-screen min-w-0 max-w-full overflow-x-hidden bg-background">
      ...
      <SeoRegionSection
        title="Häufige Fragen zu Renovierung und Bau in Gevelsberg"
        paragraphs={[
          "In unseren FAQ finden Sie Antworten zu Ablauf, Kosten, Leistungen und Terminen bei Zakho Bau. Ob Wohnungsrenovierung in Gevelsberg, Badrenovierung in Hagen oder Innenausbau in Ennepetal – viele Fragen lassen sich im Vorfeld klären, damit Sie eine realistische Entscheidungsgrundlage haben.",
          "Grundsätzlich gilt: Erstberatung und Besichtigung sind kostenlos. Wo der Leistungsumfang klar ist, bieten wir Festpreise an. Inhaber Rinas Mola bleibt Ihr direkter Ansprechpartner – von der Anfrage bis zur Übergabe.",
        ]}
      />

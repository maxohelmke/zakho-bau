...
const Anfragen = () => {
  usePageSeo({
    ...
    description:
      "Kostenlos anfragen: Zakho Bau erstellt Ihr Angebot für Renovierung, Badsanierung und Innenausbau in Gevelsberg und dem Ennepe-Ruhr-Kreis.",
    path: "/anfragen",
    structuredData: [
      {
  ...
  return (
    <div className="min-h-screen min-w-0 max-w-full overflow-x-hidden bg-background">
      ...
      <SeoRegionSection
        title="So läuft Ihre unverbindliche Projektanfrage"
        paragraphs={[
          "Über dieses Formular können Sie Zakho Bau kostenlos und unverbindlich anfragen – ob Wohnungsrenovierung in Gevelsberg, Badrenovierung in Hagen oder Innenausbau in Ennepetal. Beschreiben Sie Ihr Vorhaben so genau wie möglich: Welche Räume betrifft es, welche Arbeiten sind geplant, gibt es zeitliche Vorgaben? Je mehr Informationen wir haben, desto zielgerichteter können wir beraten.",
          "Nach Ihrer Anfrage melden wir uns in der Regel innerhalb von 24 Stunden. Bei größeren Projekten vereinbaren wir einen Vor-Ort-Termin und erstellen anschließend ein transparentes Festpreisangebot. Schlüsselfertigbau in NRW bedeutet bei uns: klare Absprachen, ein fester Ansprechpartner und saubere Umsetzung aller Gewerke aus einer Hand.",
        ]}
      />

...
const Datenschutz = () => {
  usePageSeo({
    title: "Datenschutz | Zakho Bau Gevelsberg",
    description:
      "Datenschutzerklärung von Zakho Bau gemäß DSGVO. Informationen zu Cookies, Kontaktformular und Ihren Rechten.",
    path: "/datenschutz",
      ...
      <div className="container mx-auto min-w-0 max-w-3xl px-4 py-16">
        ...
        <div className="break-safe space-y-8 text-muted-foreground leading-relaxed">
          ...
          <div>
            ...
            <p className="mt-2">
              Zakho Bau<br />
              Inhaber: Rinas Mola<br />
              Hagener Straße 44<br />
              58285 Gevelsberg<br />
              Telefon: 02332 8439131<br />
              Mobil: 0157 888 888 52<br />

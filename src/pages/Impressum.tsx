...
const Impressum = () => {
  usePageSeo({
    title: "Impressum | Zakho Bau Gevelsberg",
    description:
      "Impressum von Zakho Bau – Inhaber Rinas Mola, Hagener Straße 44, 58285 Gevelsberg. Kontakt und rechtliche Angaben.",
    path: "/impressum",

...
const Kontakt = () => {
  usePageSeo({
    title: "Kontakt Zakho Bau Gevelsberg | Bau & Sanierung",
    description:
      "Kontakt zu Zakho Bau in Gevelsberg: Telefon, E-Mail oder Formular. Schnelle, unverbindliche Beratung für Renovierung im Ennepe-Ruhr-Kreis.",
    path: "/kontakt",
    structuredData: [
      {
  ...
  return (
    <div className="min-h-screen min-w-0 max-w-full overflow-x-hidden bg-background">
      ...
      <SeoRegionSection
        title="Persönliche Beratung für Ihr Bauprojekt in der Region"
        paragraphs={[
          "Sie erreichen Zakho Bau direkt in Gevelsberg – per Telefon, E-Mail oder über unser Kontaktformular. Wir beraten Sie unverbindlich zu Renovierung, Badsanierung, Trockenbau und weiteren Leistungen im Ennepe-Ruhr-Kreis. Viele Anfragen kommen aus Gevelsberg, Ennepetal, Hagen, Schwelm und Wuppertal; kurze Anfahrten ermöglichen uns, Besichtigungstermine oft zeitnah zu vereinbaren.",
          "Unser Ladenlokal an der Hagener Straße 44 ist Montag bis Freitag von 08:00 bis 17:00 Uhr geöffnet. Kommen Sie vorbei, bringen Sie Fotos Ihres Projekts mit oder rufen Sie vorher kurz an – so können wir uns optimal vorbereiten. Für dringende Schadensfälle melden Sie sich bitte telefonisch, damit wir priorisieren können.",
        ]}
      />
